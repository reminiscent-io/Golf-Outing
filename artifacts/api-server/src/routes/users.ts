...
// Static paths must come before the `:userId` parameterized route — otherwise
// Express matches `/users/search` and `/users/me/buddies` as userId="search" /
// userId="me", failing the numeric check.
